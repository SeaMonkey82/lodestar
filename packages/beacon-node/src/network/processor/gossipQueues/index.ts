...
import {BatchValidationGossipType, GossipType, SingleValidationGossipType} from "../../gossip/interface.js";
...
const defaultGossipQueueOpts: {
  [K in SingleValidationGossipType]: GossipQueueOpts<PendingGossipsubMessage>;
} = {
...
const indexedGossipQueueOpts: {
  [K in BatchValidationGossipType]: GossipQueueOpts<PendingGossipsubMessage>;
} = {
