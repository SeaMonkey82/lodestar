...
export class EpochCache {
  ...
  afterProcessEpoch(
    ...
    this.proposersNextEpoch = {computed: false, seed: getSeed(state, currentEpoch + 1, DOMAIN_BEACON_PROPOSER)};
    ...
    const exitQueueEpoch = computeActivationExitEpoch(currentEpoch);
